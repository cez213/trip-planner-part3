...
// router is getting data serially and not parallel, would be better to do this parallel
// javascript interpreter can go on executing other callbacks, etc, but it doesn't go to the next handler
router.get('/',
	function (req, res, next) {
		models.Hotel
			.find({})
			// vanilla callback, not a promise
